<?php
    return [
		...
		"explaining_hospital"			=> "Tibbiy muassasani GPS avtomatik aniqlash orqali belgilang yoki qo'lda kiritishni qo'llang",
		...
		"password_rule"					=> "Parol kamida 4 ta belgidan iborat bo'lishi kerak",
		"save"							=> "Saqlash",
		...
		"enter_birth_date"				=> "Tug'ilgan yilingizni tanlang",
		"gender"						=> "Jinsi",
		"male"							=> "Erkak",
		"female"						=> "Ayol",
