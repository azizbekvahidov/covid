...
<div class="profile-content content">
    <div class="center-content">
        <div class="profile-photo">
            <div class="img">
                <img src="{{ asset(($user->photo == "" || $user->photo == null) ? "assets/img/user-empty.png" : "storage/avatars/".$user->photo) }}" alt=""/>
            ...
            @foreach($surveyList as $value)
                <a href="{{ route("survey.detail",$value->id) }}" class="items-problems">
                    ...
                    <div class="bottom">
                        ...
                        <span class="date">{{ date("d.m.Y H:i",strtotime($value->created_at)) }}</span>
                    </div>
                </a>
            @endforeach
            </div>
