...
<div class="problems-content content">
    <div class="problems-detail ">
        <div class="bordered">
            <div class="pa-15">
                <a href="{{ route("survey.list", $user->id) }}" class="back">
                    ...
                    <div class="info">
                        <strong>{{ $survey->category->name }}</strong>
        ...
        <div class="pa-15">
            ...
            <div class=" bordered">
                <div class="caption">
                    <strong>Описания проблемы:</strong>
                    <p>
                        {{ $survey->opinion }}
                    </p>
                </div>
                        ...
                        <div class="fileUpload">
                            @foreach($survey->files as $val)
                                <div class="thumbs">
                                    ...
                                    <div class="preview">
                                        <img src="{{ asset($val->path."/".$val->photo) }}" alt="" />
                                    </div>
                                </div>
                            @endforeach
                        </div>
...
@section("js")
    <script>
        ...
        let blob = "data:audio/mp3;{{ base64_encode($survey->audio) }}";
        console.log(blob);
